...
class Regex {
    public static void main(String[] args) {
        ...
        System.out.println("The following pattern ('\\d'){36} matches : Any digit character (0-9) with the \\d command while the {36} is a quantifier so it only matches a chain of 36 consecutive digits");
